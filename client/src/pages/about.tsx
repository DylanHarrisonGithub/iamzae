  ...
  return (
    <div className="py-16 px-4 mx-auto fan">
      <div className="container py-16 min-h-screen">
        ...
        <div className="flex items-center content-center p-16  md:mx-16 glass rounded-lg">
          <p className="rainbow-text">
          &nbsp;&nbsp;&nbsp;&nbsp;In the heart of Milwaukee's vibrant music scene, I found my calling and passion as a house music DJ. Growing up surrounded by the rhythm of the city, I was captivated by the pulsating beats that echoed through the streets. From the moment I first stepped into a dimly lit nightclub and felt the music reverberate through my soul, I knew I had discovered my truest form of expression.
          <br></br>
